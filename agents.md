...
## Deployment 2026-06-20T07:44:03.075Z

- Target: production
- Production URL: https://world-cup-match-intelligence-center.vercel.app
- Deployment URL: https://world-cup-match-intelligence-center-ntdydkfl0.vercel.app
- Deployment ID: dpl_BxMbZDb1Mx1rFy1MQ5Ysmxz55iph
- Inspect: https://vercel.com/jason-wang-s-projects1/world-cup-match-intelligence-center/BxMbZDb1Mx1rFy1MQ5Ysmxz55iph
- Verification: passed
- Commands: npm run check:data, npm run lint, npm test, npm run build, npx vercel deploy --prod --yes
- Smoke checks:
  - /: HTTP 200, passed
  ...
  - /api/matches#schedule-coverage: HTTP 200, passed
  - /#schedule-coverage: HTTP 200, passed
    - Production HTML snippet: 完整小组赛数据 72 场小组赛数据 · 2026-06-12 至 2026-06-28 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 🇳🇱 荷兰 vs 🇸🇪 瑞典 2026-06-21 06/21 01:00 · 未开始 🇩🇪 德国 vs 🇨🇮 科特迪瓦 2026-06-21 06/21 04:00 · 未开始 🇪🇨 厄瓜多尔 vs 🇨🇼 库拉索 2026-06-21 06/21 08:00 · 未开始 🇹🇳 突尼斯 vs 🇯🇵 日本 2026-06-21 06/21 12:00 · 未开始 
  - /api/matches#beijing-2026-06-19: HTTP 200, passed
  - /#today-focus: HTTP 200, passed
  - /#status-sections: HTTP 200, passed
  - /api/matches#today-results: HTTP 200, passed
  ...
  - /#group-standings: HTTP 200, passed
    - Production HTML snippet: 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。 
  - /#group-standings-consistency: HTTP 200, passed
    - Production HTML snippet: main: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::j94zj-1781941434077-c5820d66fc06, x-matched-path=/, ok=true | main-random-query: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::2lr75-1781941434808-358bdf5f6f4e, x-matched-path=/, ok=true | deployment-url-vercel-curl: status=200, cache-control=vercel curl, x-vercel-cache=vercel curl, x-vercel-id=vercel curl, x-matched-path=vercel curl, ok=true
  - /teams/mexico#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::shdrw-1781941439265-545127d202fb | A 组积分榜与出线形势 当前球队： 墨西哥 排名 球队 数据摘要 出线形势 1 墨西哥 · 当前球队 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 南非 · 2026-06-12 06/12 09:00 · 实际比分 墨西哥 2-0 南非 vs 韩国 · 2026-06-19 06/19 09:00 · 实际比分 墨西哥 1-0 韩国 剩余赛程 vs 捷克 · 2026-06-25 06/25 09:00 ，北京时间 · 未开始
  - /teams/canada#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::shdrw-1781941439914-526e338344b8 | B 组积分榜与出线形势 当前球队： 加拿大 排名 球队 数据摘要 出线形势 1 加拿大 · 当前球队 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 波黑 · 2026-06-13 06/13 04:00 · 实际比分 加拿大 1-1 波黑 vs 卡塔尔 · 2026-06-19 06/19 10:00 · 实际比分 加拿大 6-0 卡塔尔 剩余赛程 vs 瑞士 · 2026-06-25 06/25 03:00 ，北京时间 · 未开始
  - /matches/match-008#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::dqqcm-1781941440347-ee994fad312c | 捷克 vs 南非 北京时间 06/19 05:00 · Atlanta · Atlanta Stadium 实际比分 1-1 赛前预测 2-1 捷克 vs 南非 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 捷克 在模型中更占优势。当前主胜/平/客胜概率为 50% / 20.8% / 29.2%，预测比分 2 : 1。 捷克 胜 50 % 平局 20.8 % 南非 胜 29.2 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 09:19:42 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 04:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：捷克 1-1 南非 赛前预测：2-1；期望进球 1.5-0.6 A 组积分榜摘要 所属小组： A 组 本场赛果已计入 A 组积分榜。捷克获得 1 分，南非获得 1 分。 排名 球队 数据摘要 出线形势 1 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 1 - 1 赛前预测 2 - 1 胜平负方向 未命中 比分完全命中 未命中 净胜球偏差 1 总进球偏差 1 胜平负方向未命中，净胜球偏差 1，总进球偏差 1。 模型需要更重视临场伤停、红黄牌和比赛节
  - /matches/match-010#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::dqqcm-1781941440743-ad6bcbc9fba0 | 加拿大 vs 卡塔尔 北京时间 06/19 10:00 · Vancouver · BC Place Vancouver 实际比分 6-0 赛前预测 2-1 加拿大 vs 卡塔尔 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 加拿大 在模型中更占优势。当前主胜/平/客胜概率为 54.5% / 17.2% / 28.3%，预测比分 2 : 1。 加拿大 胜 54.5 % 平局 17.2 % 卡塔尔 胜 28.3 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 09:19:42 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 09:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：加拿大 6-0 卡塔尔 赛前预测：2-1；期望进球 1.6-0.7 B 组积分榜摘要 所属小组： B 组 本场赛果已计入 B 组积分榜。加拿大获得 3 分，卡塔尔获得 0 分。 排名 球队 数据摘要 出线形势 1 加拿大 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 6 - 0 赛前预测 2 - 1 胜平负方向 命中 比分完全命中 未命中 净胜球偏差 5 总进球偏差 3 胜平负方向命中，净胜球偏差 5，总进球偏差 3。
  - /matches/match-029#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::4rp7b-1781941441137-e6b4ad0eb29c | 美国 vs Australia 北京时间 06/20 03:00 · Seattle · Seattle Stadium 比赛可能已结束，但当前赛果未抓取，等待数据更新。 赛果待抓取 待更新 赛前预测 1-1 美国 vs Australia 赛前智能分析 官方来源 · FIFA World Cup 2026 官方赛程 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 美国 在模型中更占优势。当前主胜/平/客胜概率为 43.5% / 23.5% / 33%，预测比分 1 : 1。 美国 胜 43.5 % 平局 23.5 % Australia 胜 33 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 赛果待更新 比赛可能已结束，但当前赛果未抓取，等待数据更新。 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 09:19:42 赛果更新时间 暂无，等待赛果补录 赛前预测快照 2026/6/20 02:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：赛果待抓取 / 数据待更新 赛前预测：1-1；期望进球 1.3-1.4 D 组积分榜摘要 所属小组： D 组 赛果尚未产生，本场比赛结果将影响本组积分榜、直接出线区和第三名竞争区排序。 排名 球队 数据摘要 出线形势 1 美国 进球 4｜失球 1｜净胜球 +3｜积分 3 当前位于直接出线区，仍需后续比赛确认 2 Australia 进球 2｜失球 0｜净胜球 +2｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 Turkiye 进球 0｜失球 2｜净胜球 -2｜积分 0 当前处于第三名竞争区 4 巴拉圭 进球 1｜失球 4｜净胜球 -3｜积分 0 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 预测复盘 比赛可能已结束，但当前赛果未抓取，等待数据更新。 赛果更新后，将自动计算方向命中、比分命中、
  - /#ui-readability: HTTP 200, passed
    - Production HTML snippet: status=200 | cache-control=private, no-cache, no-store, max-age=0, must-revalidate | x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::92srf-1781941441488-89e38dbfeb8a | x-matched-path=/ | forbidden raw body=none | forbidden visible text=none | 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。  | 筛选比赛 按日期、小组、球队、状态和排序方式浏览。 全部日期 2026-06-12 2026-06-13 2026-06-14 2026-06-15 2026-06-16 2026-06-17 2026-06-18 2026-06-19 2026-06-20 2026-06-21 2026-06-22 2026-06-23 2026-06-24 2026-06-25 2026-06-26 2026-06-27 2026-06-28 全部小组 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 当前小组/收藏球队 🇲🇽 墨西哥 (MEX) 🇿🇦 南非 (RSA) 🇰🇷 韩国 (KOR) 🇨🇿 捷克 (CZE) 全部状态 进行中 进行中，比分待更新 已结束 未开始 赛果待更新 时间或数据异常 按开赛时间 按冷门风险 🇲🇽 墨西哥 MEX 🇿🇦 南非 RSA 🇰🇷 韩国 KOR 🇨🇿 捷克 CZE 显示当前小组/收藏球队；完整 48 队请用搜索定位。 完整小组赛数据 72 场小组赛数据 · 2026-06-12 至 2026-06-28 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 🇳🇱 荷兰 vs 🇸🇪 瑞典 2026-06-21 06/21 01:00 · 未开始 🇩🇪 德国 vs 🇨🇮 科特迪瓦 2026-06-21 06/21 04:00 · 未开始 🇪🇨 厄瓜多尔 vs 🇨🇼 库拉索 2026-06-21 06/21 08:0 | 模型表现 规则模型复盘 已复盘比赛 28 方向命中率 57.1 % 比分完全命中 2 平均总进球误差 1.6 28 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇺🇸 美国 78 / 🇦🇺 澳大利亚 84 防守 🇺🇸 美国 75 / 🇦🇺 澳大利亚 82 中场 🇺🇸 美国 77 / 🇦🇺 澳大利亚 83 状态 🇺🇸 美国 80 / 🇦🇺 澳大利亚 86 节奏 🇺🇸 美国 83 / 🇦🇺 澳大利亚 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 🇳🇴 挪威 94 🇦🇹 奥地利 94 🇦🇺 澳大利亚 93 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇸🇪 瑞典 78% 🇺🇸 美国 77% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 🏴 英格兰 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 数据来源与更新时间 本地数据最近更新： 2026-06-
  - /#chart-disclaimers: HTTP 200, passed
    - Production HTML snippet: 模型表现 规则模型复盘 已复盘比赛 28 方向命中率 57.1 % 比分完全命中 2 平均总进球误差 1.6 28 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇺🇸 美国 78 / 🇦🇺 澳大利亚 84 防守 🇺🇸 美国 75 / 🇦🇺 澳大利亚 82 中场 🇺🇸 美国 77 / 🇦🇺 澳大利亚 83 状态 🇺🇸 美国 80 / 🇦🇺 澳大利亚 86 节奏 🇺🇸 美国 83 / 🇦🇺 澳大利亚 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 🇳🇴 挪威 94 🇦🇹 奥地利 94 🇦🇺 澳大利亚 93 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇸🇪 瑞典 78% 🇺🇸 美国 77% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 🏴 英格兰 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 

## Deployment 2026-06-20T07:45:47.132Z

- Target: production
- Production URL: https://world-cup-match-intelligence-center.vercel.app
- Deployment URL: https://world-cup-match-intelligence-center-79yl74s56.vercel.app
- Deployment ID: dpl_6sp5nUyTyNGCobmB655Yk5XDRFGe
- Inspect: https://vercel.com/jason-wang-s-projects1/world-cup-match-intelligence-center/6sp5nUyTyNGCobmB655Yk5XDRFGe
- Verification: passed
- Commands: npm run check:data, npm run lint, npm test, npm run build, npx vercel deploy --prod --yes
- Smoke checks:
  - /: HTTP 200, passed
  ...
  - /#group-standings: HTTP 200, passed
    - Production HTML snippet: 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。 
  - /#group-standings-consistency: HTTP 200, passed
    - Production HTML snippet: main: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::6fvv5-1781941538489-3674b69f8b31, x-matched-path=/, ok=true | main-random-query: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::jrw2j-1781941539165-ae5fa5ab7470, x-matched-path=/, ok=true | deployment-url-vercel-curl: status=200, cache-control=vercel curl, x-vercel-cache=vercel curl, x-vercel-id=vercel curl, x-matched-path=vercel curl, ok=true
  - /teams/mexico#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::kjj7p-1781941543125-79bc20739dbb | A 组积分榜与出线形势 当前球队： 墨西哥 排名 球队 数据摘要 出线形势 1 墨西哥 · 当前球队 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 南非 · 2026-06-12 06/12 09:00 · 实际比分 墨西哥 2-0 南非 vs 韩国 · 2026-06-19 06/19 09:00 · 实际比分 墨西哥 1-0 韩国 剩余赛程 vs 捷克 · 2026-06-25 06/25 09:00 ，北京时间 · 未开始
  - /teams/canada#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::shdrw-1781941543936-165805f61748 | B 组积分榜与出线形势 当前球队： 加拿大 排名 球队 数据摘要 出线形势 1 加拿大 · 当前球队 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 波黑 · 2026-06-13 06/13 04:00 · 实际比分 加拿大 1-1 波黑 vs 卡塔尔 · 2026-06-19 06/19 10:00 · 实际比分 加拿大 6-0 卡塔尔 剩余赛程 vs 瑞士 · 2026-06-25 06/25 03:00 ，北京时间 · 未开始
  - /matches/match-008#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::shdrw-1781941544317-f7895f5cd3f5 | 捷克 vs 南非 北京时间 06/19 05:00 · Atlanta · Atlanta Stadium 实际比分 1-1 赛前预测 2-1 捷克 vs 南非 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 捷克 在模型中更占优势。当前主胜/平/客胜概率为 50% / 20.8% / 29.2%，预测比分 2 : 1。 捷克 胜 50 % 平局 20.8 % 南非 胜 29.2 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 09:19:42 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 04:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：捷克 1-1 南非 赛前预测：2-1；期望进球 1.5-0.6 A 组积分榜摘要 所属小组： A 组 本场赛果已计入 A 组积分榜。捷克获得 1 分，南非获得 1 分。 排名 球队 数据摘要 出线形势 1 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 1 - 1 赛前预测 2 - 1 胜平负方向 未命中 比分完全命中 未命中 净胜球偏差 1 总进球偏差 1 胜平负方向未命中，净胜球偏差 1，总进球偏差 1。 模型需要更重视临场伤停、红黄牌和比赛节
  - /matches/match-010#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::6fvv5-1781941544699-83d393b3df96 | 加拿大 vs 卡塔尔 北京时间 06/19 10:00 · Vancouver · BC Place Vancouver 实际比分 6-0 赛前预测 2-1 加拿大 vs 卡塔尔 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 加拿大 在模型中更占优势。当前主胜/平/客胜概率为 54.5% / 17.2% / 28.3%，预测比分 2 : 1。 加拿大 胜 54.5 % 平局 17.2 % 卡塔尔 胜 28.3 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 09:19:42 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 09:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：加拿大 6-0 卡塔尔 赛前预测：2-1；期望进球 1.6-0.7 B 组积分榜摘要 所属小组： B 组 本场赛果已计入 B 组积分榜。加拿大获得 3 分，卡塔尔获得 0 分。 排名 球队 数据摘要 出线形势 1 加拿大 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 6 - 0 赛前预测 2 - 1 胜平负方向 命中 比分完全命中 未命中 净胜球偏差 5 总进球偏差 3 胜平负方向命中，净胜球偏差 5，总进球偏差 3。
  - /matches/match-029#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::shdrw-1781941545116-d83077cac245 | 美国 vs Australia 北京时间 06/20 03:00 · Seattle · Seattle Stadium 比赛可能已结束，但当前赛果未抓取，等待数据更新。 赛果待抓取 待更新 赛前预测 1-1 美国 vs Australia 赛前智能分析 官方来源 · FIFA World Cup 2026 官方赛程 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 美国 在模型中更占优势。当前主胜/平/客胜概率为 43.5% / 23.5% / 33%，预测比分 1 : 1。 美国 胜 43.5 % 平局 23.5 % Australia 胜 33 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 赛果待更新 比赛可能已结束，但当前赛果未抓取，等待数据更新。 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 09:19:42 赛果更新时间 暂无，等待赛果补录 赛前预测快照 2026/6/20 02:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：赛果待抓取 / 数据待更新 赛前预测：1-1；期望进球 1.3-1.4 D 组积分榜摘要 所属小组： D 组 赛果尚未产生，本场比赛结果将影响本组积分榜、直接出线区和第三名竞争区排序。 排名 球队 数据摘要 出线形势 1 美国 进球 4｜失球 1｜净胜球 +3｜积分 3 当前位于直接出线区，仍需后续比赛确认 2 Australia 进球 2｜失球 0｜净胜球 +2｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 Turkiye 进球 0｜失球 2｜净胜球 -2｜积分 0 当前处于第三名竞争区 4 巴拉圭 进球 1｜失球 4｜净胜球 -3｜积分 0 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 预测复盘 比赛可能已结束，但当前赛果未抓取，等待数据更新。 赛果更新后，将自动计算方向命中、比分命中、
  - /#ui-readability: HTTP 200, passed
    - Production HTML snippet: status=200 | cache-control=private, no-cache, no-store, max-age=0, must-revalidate | x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::jrw2j-1781941545528-7c99a1c0e0bc | x-matched-path=/ | forbidden raw body=none | forbidden visible text=none | 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。  | 筛选比赛 按日期、小组、球队、状态和排序方式浏览。 全部日期 2026-06-12 2026-06-13 2026-06-14 2026-06-15 2026-06-16 2026-06-17 2026-06-18 2026-06-19 2026-06-20 2026-06-21 2026-06-22 2026-06-23 2026-06-24 2026-06-25 2026-06-26 2026-06-27 2026-06-28 全部小组 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 当前小组/收藏球队 🇲🇽 墨西哥 (MEX) 🇿🇦 南非 (RSA) 🇰🇷 韩国 (KOR) 🇨🇿 捷克 (CZE) 全部状态 进行中 进行中，比分待更新 已结束 未开始 赛果待更新 时间或数据异常 按开赛时间 按冷门风险 🇲🇽 墨西哥 MEX 🇿🇦 南非 RSA 🇰🇷 韩国 KOR 🇨🇿 捷克 CZE 显示当前小组/收藏球队；完整 48 队请用搜索定位。 完整小组赛数据 72 场小组赛数据 · 2026-06-12 至 2026-06-28 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 🇳🇱 荷兰 vs 🇸🇪 瑞典 2026-06-21 06/21 01:00 · 未开始 🇩🇪 德国 vs 🇨🇮 科特迪瓦 2026-06-21 06/21 04:00 · 未开始 🇪🇨 厄瓜多尔 vs 🇨🇼 库拉索 2026-06-21 06/21 08:0 | 模型表现 规则模型复盘 已复盘比赛 28 方向命中率 57.1 % 比分完全命中 2 平均总进球误差 1.6 28 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇺🇸 美国 78 / 🇦🇺 澳大利亚 84 防守 🇺🇸 美国 75 / 🇦🇺 澳大利亚 82 中场 🇺🇸 美国 77 / 🇦🇺 澳大利亚 83 状态 🇺🇸 美国 80 / 🇦🇺 澳大利亚 86 节奏 🇺🇸 美国 83 / 🇦🇺 澳大利亚 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 🇳🇴 挪威 94 🇦🇹 奥地利 94 🇦🇺 澳大利亚 93 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇸🇪 瑞典 78% 🇺🇸 美国 77% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 🏴 英格兰 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 数据来源与更新时间 本地数据最近更新： 2026-06-
  - /#chart-disclaimers: HTTP 200, passed
    - Production HTML snippet: 模型表现 规则模型复盘 已复盘比赛 28 方向命中率 57.1 % 比分完全命中 2 平均总进球误差 1.6 28 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇺🇸 美国 78 / 🇦🇺 澳大利亚 84 防守 🇺🇸 美国 75 / 🇦🇺 澳大利亚 82 中场 🇺🇸 美国 77 / 🇦🇺 澳大利亚 83 状态 🇺🇸 美国 80 / 🇦🇺 澳大利亚 86 节奏 🇺🇸 美国 83 / 🇦🇺 澳大利亚 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 🇳🇴 挪威 94 🇦🇹 奥地利 94 🇦🇺 澳大利亚 93 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇸🇪 瑞典 78% 🇺🇸 美国 77% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 🏴 英格兰 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 

## Deployment 2026-06-20T07:52:07.473Z

- Target: production
- Production URL: https://world-cup-match-intelligence-center.vercel.app
- Deployment URL: https://world-cup-match-intelligence-center-d7fnw7vwf.vercel.app
- Deployment ID: dpl_8uSjEKjXpo1yLxNccwhzjxikihWU
- Inspect: https://vercel.com/jason-wang-s-projects1/world-cup-match-intelligence-center/8uSjEKjXpo1yLxNccwhzjxikihWU
- Verification: passed
- Commands: npm run check:data, npm run lint, npm test, npm run build, npx vercel deploy --prod --yes
- Smoke checks:
  - /: HTTP 200, passed
  ...
  - /#group-standings: HTTP 200, passed
    - Production HTML snippet: 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。 
  - /#group-standings-consistency: HTTP 200, passed
    - Production HTML snippet: main: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::jrw2j-1781941918834-9439bc9c0550, x-matched-path=/, ok=true | main-random-query: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::65tpg-1781941919651-2a21ccc7a820, x-matched-path=/, ok=true | deployment-url-vercel-curl: status=200, cache-control=vercel curl, x-vercel-cache=vercel curl, x-vercel-id=vercel curl, x-matched-path=vercel curl, ok=true
  - /teams/mexico#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::2cgv4-1781941923793-2d6b10805f34 | A 组积分榜与出线形势 当前球队： 墨西哥 排名 球队 数据摘要 出线形势 1 墨西哥 · 当前球队 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 南非 · 2026-06-12 06/12 09:00 · 实际比分 墨西哥 2-0 南非 vs 韩国 · 2026-06-19 06/19 09:00 · 实际比分 墨西哥 1-0 韩国 剩余赛程 vs 捷克 · 2026-06-25 06/25 09:00 ，北京时间 · 未开始
  - /teams/canada#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::92srf-1781941924544-8633455281b6 | B 组积分榜与出线形势 当前球队： 加拿大 排名 球队 数据摘要 出线形势 1 加拿大 · 当前球队 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 波黑 · 2026-06-13 06/13 04:00 · 实际比分 加拿大 1-1 波黑 vs 卡塔尔 · 2026-06-19 06/19 10:00 · 实际比分 加拿大 6-0 卡塔尔 剩余赛程 vs 瑞士 · 2026-06-25 06/25 03:00 ，北京时间 · 未开始
  - /matches/match-008#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::92srf-1781941924895-263e85ac4cd9 | 捷克 vs 南非 北京时间 06/19 05:00 · Atlanta · Atlanta Stadium 实际比分 1-1 赛前预测 2-1 捷克 vs 南非 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 捷克 在模型中更占优势。当前主胜/平/客胜概率为 50% / 20.8% / 29.2%，预测比分 2 : 1。 捷克 胜 50 % 平局 20.8 % 南非 胜 29.2 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 15:50:47 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 04:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：捷克 1-1 南非 赛前预测：2-1；期望进球 1.5-0.6 A 组积分榜摘要 所属小组： A 组 本场赛果已计入 A 组积分榜。捷克获得 1 分，南非获得 1 分。 排名 球队 数据摘要 出线形势 1 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 1 - 1 赛前预测 2 - 1 胜平负方向 未命中 比分完全命中 未命中 净胜球偏差 1 总进球偏差 1 胜平负方向未命中，净胜球偏差 1，总进球偏差 1。 模型需要更重视临场伤停、红黄牌和比赛节
  - /matches/match-010#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::vphws-1781941925280-9d12abe5801c | 加拿大 vs 卡塔尔 北京时间 06/19 10:00 · Vancouver · BC Place Vancouver 实际比分 6-0 赛前预测 2-1 加拿大 vs 卡塔尔 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 加拿大 在模型中更占优势。当前主胜/平/客胜概率为 54.5% / 17.2% / 28.3%，预测比分 2 : 1。 加拿大 胜 54.5 % 平局 17.2 % 卡塔尔 胜 28.3 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 15:50:47 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 09:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：加拿大 6-0 卡塔尔 赛前预测：2-1；期望进球 1.6-0.7 B 组积分榜摘要 所属小组： B 组 本场赛果已计入 B 组积分榜。加拿大获得 3 分，卡塔尔获得 0 分。 排名 球队 数据摘要 出线形势 1 加拿大 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 6 - 0 赛前预测 2 - 1 胜平负方向 命中 比分完全命中 未命中 净胜球偏差 5 总进球偏差 3 胜平负方向命中，净胜球偏差 5，总进球偏差 3。
  - /matches/match-029#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::vphws-1781941925655-b64762a562ed | 美国 vs Australia 北京时间 06/20 03:00 · Seattle · Seattle Stadium 比赛可能已结束，但当前赛果未抓取，等待数据更新。 赛果待抓取 待更新 赛前预测 1-1 美国 vs Australia 赛前智能分析 官方来源 · FIFA World Cup 2026 官方赛程 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 美国 在模型中更占优势。当前主胜/平/客胜概率为 43.5% / 23.5% / 33%，预测比分 1 : 1。 美国 胜 43.5 % 平局 23.5 % Australia 胜 33 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 赛果待更新 比赛可能已结束，但当前赛果未抓取，等待数据更新。 数据时间 来源抓取时间 2026/6/20 15:50:41 数据规范化时间 2026/6/20 15:50:47 赛果更新时间 暂无，等待赛果补录 赛前预测快照 2026/6/20 02:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：赛果待抓取 / 数据待更新 赛前预测：1-1；期望进球 1.3-1.4 D 组积分榜摘要 所属小组： D 组 赛果尚未产生，本场比赛结果将影响本组积分榜、直接出线区和第三名竞争区排序。 排名 球队 数据摘要 出线形势 1 美国 进球 4｜失球 1｜净胜球 +3｜积分 3 当前位于直接出线区，仍需后续比赛确认 2 Australia 进球 2｜失球 0｜净胜球 +2｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 Turkiye 进球 0｜失球 2｜净胜球 -2｜积分 0 当前处于第三名竞争区 4 巴拉圭 进球 1｜失球 4｜净胜球 -3｜积分 0 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 预测复盘 比赛可能已结束，但当前赛果未抓取，等待数据更新。 赛果更新后，将自动计算方向命中、比分命中、
  - /#ui-readability: HTTP 200, passed
    - Production HTML snippet: status=200 | cache-control=private, no-cache, no-store, max-age=0, must-revalidate | x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::hnbjg-1781941926048-83d9105701d6 | x-matched-path=/ | forbidden raw body=none | forbidden visible text=none | 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。  | 筛选比赛 按日期、小组、球队、状态和排序方式浏览。 全部日期 2026-06-12 2026-06-13 2026-06-14 2026-06-15 2026-06-16 2026-06-17 2026-06-18 2026-06-19 2026-06-20 2026-06-21 2026-06-22 2026-06-23 2026-06-24 2026-06-25 2026-06-26 2026-06-27 2026-06-28 全部小组 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 当前小组/收藏球队 🇲🇽 墨西哥 (MEX) 🇿🇦 南非 (RSA) 🇰🇷 韩国 (KOR) 🇨🇿 捷克 (CZE) 全部状态 进行中 进行中，比分待更新 已结束 未开始 赛果待更新 时间或数据异常 按开赛时间 按冷门风险 🇲🇽 墨西哥 MEX 🇿🇦 南非 RSA 🇰🇷 韩国 KOR 🇨🇿 捷克 CZE 显示当前小组/收藏球队；完整 48 队请用搜索定位。 完整小组赛数据 72 场小组赛数据 · 2026-06-12 至 2026-06-28 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 🇳🇱 荷兰 vs 🇸🇪 瑞典 2026-06-21 06/21 01:00 · 未开始 🇩🇪 德国 vs 🇨🇮 科特迪瓦 2026-06-21 06/21 04:00 · 未开始 🇪🇨 厄瓜多尔 vs 🇨🇼 库拉索 2026-06-21 06/21 08:0 | 模型表现 规则模型复盘 已复盘比赛 28 方向命中率 57.1 % 比分完全命中 2 平均总进球误差 1.6 28 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇺🇸 美国 78 / 🇦🇺 澳大利亚 84 防守 🇺🇸 美国 75 / 🇦🇺 澳大利亚 82 中场 🇺🇸 美国 77 / 🇦🇺 澳大利亚 83 状态 🇺🇸 美国 80 / 🇦🇺 澳大利亚 86 节奏 🇺🇸 美国 83 / 🇦🇺 澳大利亚 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 🇳🇴 挪威 94 🇦🇹 奥地利 94 🇦🇺 澳大利亚 93 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇸🇪 瑞典 78% 🇺🇸 美国 77% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 🏴 英格兰 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 数据来源与更新时间 本地数据最近更新： 2026-06-
  - /#chart-disclaimers: HTTP 200, passed
    - Production HTML snippet: 模型表现 规则模型复盘 已复盘比赛 28 方向命中率 57.1 % 比分完全命中 2 平均总进球误差 1.6 28 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇺🇸 美国 78 / 🇦🇺 澳大利亚 84 防守 🇺🇸 美国 75 / 🇦🇺 澳大利亚 82 中场 🇺🇸 美国 77 / 🇦🇺 澳大利亚 83 状态 🇺🇸 美国 80 / 🇦🇺 澳大利亚 86 节奏 🇺🇸 美国 83 / 🇦🇺 澳大利亚 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 🇳🇴 挪威 94 🇦🇹 奥地利 94 🇦🇺 澳大利亚 93 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇸🇪 瑞典 78% 🇺🇸 美国 77% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 🏴 英格兰 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 

## Deployment 2026-06-20T08:07:41.812Z

- Target: production
- Production URL: https://world-cup-match-intelligence-center.vercel.app
- Deployment URL: https://world-cup-match-intelligence-center-3kf0p2cgi.vercel.app
- Deployment ID: dpl_87bPPQnuooHA7JUKbbKgww2z1t7d
- Inspect: https://vercel.com/jason-wang-s-projects1/world-cup-match-intelligence-center/87bPPQnuooHA7JUKbbKgww2z1t7d
- Verification: failed
- Commands: npm run check:data, npm run lint, npm test, npm run build, npx vercel deploy --prod --yes
- Smoke checks:
  - /: HTTP 200, passed
  ...
  - /#group-standings: HTTP 200, passed
    - Production HTML snippet: 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。 
  - /#group-standings-consistency: HTTP 200, passed
    - Production HTML snippet: main: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::4rp7b-1781942852537-232952390059, x-matched-path=/, ok=true | main-random-query: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::p4xvp-1781942853182-da6dfa2f223f, x-matched-path=/, ok=true | deployment-url-vercel-curl: status=200, cache-control=vercel curl, x-vercel-cache=vercel curl, x-vercel-id=vercel curl, x-matched-path=vercel curl, ok=true
  - /teams/mexico#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::8p8xx-1781942857780-3ab4a8975cbf | A 组积分榜与出线形势 当前球队： 墨西哥 排名 球队 数据摘要 出线形势 1 墨西哥 · 当前球队 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 南非 · 2026-06-12 06/12 09:00 · 实际比分 墨西哥 2-0 南非 vs 韩国 · 2026-06-19 06/19 09:00 · 实际比分 墨西哥 1-0 韩国 剩余赛程 vs 捷克 · 2026-06-25 06/25 09:00 ，北京时间 · 未开始
  - /teams/canada#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::8p8xx-1781942858480-c7f23c4bf0d6 | B 组积分榜与出线形势 当前球队： 加拿大 排名 球队 数据摘要 出线形势 1 加拿大 · 当前球队 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 波黑 · 2026-06-13 06/13 04:00 · 实际比分 加拿大 1-1 波黑 vs 卡塔尔 · 2026-06-19 06/19 10:00 · 实际比分 加拿大 6-0 卡塔尔 剩余赛程 vs 瑞士 · 2026-06-25 06/25 03:00 ，北京时间 · 未开始
  - /matches/match-008#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::p4nn8-1781942858898-c11e278d3190 | 捷克 vs 南非 北京时间 06/19 05:00 · Atlanta · Atlanta Stadium 实际比分 1-1 赛前预测 2-1 捷克 vs 南非 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 捷克 在模型中更占优势。当前主胜/平/客胜概率为 50% / 20.8% / 29.2%，预测比分 2 : 1。 捷克 胜 50 % 平局 20.8 % 南非 胜 29.2 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 16:05:20 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 04:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：捷克 1-1 南非 赛前预测：2-1；期望进球 1.5-0.6 A 组积分榜摘要 所属小组： A 组 本场赛果已计入 A 组积分榜。捷克获得 1 分，南非获得 1 分。 排名 球队 数据摘要 出线形势 1 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 1 - 1 赛前预测 2 - 1 胜平负方向 未命中 比分完全命中 未命中 净胜球偏差 1 总进球偏差 1 胜平负方向未命中，净胜球偏差 1，总进球偏差 1。 模型需要更重视临场伤停、红黄牌和比赛节
  - /matches/match-010#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::lkc8q-1781942859382-1fb986ec2194 | 加拿大 vs 卡塔尔 北京时间 06/19 10:00 · Vancouver · BC Place Vancouver 实际比分 6-0 赛前预测 2-1 加拿大 vs 卡塔尔 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 加拿大 在模型中更占优势。当前主胜/平/客胜概率为 54.5% / 17.2% / 28.3%，预测比分 2 : 1。 加拿大 胜 54.5 % 平局 17.2 % 卡塔尔 胜 28.3 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 16:05:20 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 09:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：加拿大 6-0 卡塔尔 赛前预测：2-1；期望进球 1.6-0.7 B 组积分榜摘要 所属小组： B 组 本场赛果已计入 B 组积分榜。加拿大获得 3 分，卡塔尔获得 0 分。 排名 球队 数据摘要 出线形势 1 加拿大 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 6 - 0 赛前预测 2 - 1 胜平负方向 命中 比分完全命中 未命中 净胜球偏差 5 总进球偏差 3 胜平负方向命中，净胜球偏差 5，总进球偏差 3。
  - /matches/match-029#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::lkc8q-1781942859802-aed198305230 | 美国 vs Australia 北京时间 06/20 03:00 · Seattle · Seattle Stadium 实际比分 2-0 赛前预测 1-1 美国 vs Australia 赛前智能分析 官方来源 · FIFA World Cup 2026 官方赛程 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 美国 在模型中更占优势。当前主胜/平/客胜概率为 43.5% / 23.5% / 33%，预测比分 1 : 1。 美国 胜 43.5 % 平局 23.5 % Australia 胜 33 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/20 16:00:00 数据时间 来源抓取时间 2026/6/20 16:00:00 数据规范化时间 2026/6/20 16:05:20 赛果更新时间 2026/6/20 16:00:00 赛前预测快照 2026/6/20 02:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：美国 2-0 Australia 赛前预测：1-1；期望进球 1.3-1.4 D 组积分榜摘要 所属小组： D 组 本场赛果已计入 D 组积分榜。美国获得 3 分，Australia获得 0 分。 排名 球队 数据摘要 出线形势 1 美国 进球 6｜失球 1｜净胜球 +5｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 Australia 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 巴拉圭 进球 2｜失球 4｜净胜球 -2｜积分 3 当前处于第三名竞争区 4 Turkiye 进球 0｜失球 3｜净胜球 -3｜积分 0 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 2 - 0 赛前预测 1 - 1 胜平负方向 未命中 比分完全命中 未命中 净胜球偏差 2 总进球偏差 
  - /#ui-readability: HTTP 200, missing 28 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛
    - Production HTML snippet: status=200 | cache-control=private, no-cache, no-store, max-age=0, must-revalidate | x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::lkc8q-1781942860174-b433bd473be0 | x-matched-path=/ | forbidden raw body=none | forbidden visible text=none | 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。  | 筛选比赛 按日期、小组、球队、状态和排序方式浏览。 全部日期 2026-06-12 2026-06-13 2026-06-14 2026-06-15 2026-06-16 2026-06-17 2026-06-18 2026-06-19 2026-06-20 2026-06-21 2026-06-22 2026-06-23 2026-06-24 2026-06-25 2026-06-26 2026-06-27 2026-06-28 全部小组 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 当前小组/收藏球队 🇲🇽 墨西哥 (MEX) 🇿🇦 南非 (RSA) 🇰🇷 韩国 (KOR) 🇨🇿 捷克 (CZE) 全部状态 进行中 进行中，比分待更新 已结束 未开始 赛果待更新 时间或数据异常 按开赛时间 按冷门风险 🇲🇽 墨西哥 MEX 🇿🇦 南非 RSA 🇰🇷 韩国 KOR 🇨🇿 捷克 CZE 显示当前小组/收藏球队；完整 48 队请用搜索定位。 完整小组赛数据 72 场小组赛数据 · 2026-06-12 至 2026-06-28 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 🇳🇱 荷兰 vs 🇸🇪 瑞典 2026-06-21 06/21 01:00 · 未开始 🇩🇪 德国 vs 🇨🇮 科特迪瓦 2026-06-21 06/21 04:00 · 未开始 🇪🇨 厄瓜多尔 vs 🇨🇼 库拉索 2026-06-21 06/21 08:0 | 模型表现 规则模型复盘 已复盘比赛 32 方向命中率 56.3 % 比分完全命中 3 平均总进球误差 1.5 32 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇳🇱 荷兰 90 / 🇸🇪 瑞典 83 防守 🇳🇱 荷兰 88 / 🇸🇪 瑞典 81 中场 🇳🇱 荷兰 89 / 🇸🇪 瑞典 82 状态 🇳🇱 荷兰 88 / 🇸🇪 瑞典 85 节奏 🇳🇱 荷兰 79 / 🇸🇪 瑞典 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇧🇷 巴西 96 🇲🇦 摩洛哥 96 🇺🇸 美国 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇺🇸 美国 92% 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇧🇷 巴西 81% 🇸🇪 瑞典 78% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 数据来源与更新时间 本地数据最近更新： 2026-06-20 16:05 ，北
  - /#chart-disclaimers: HTTP 200, passed
    - Production HTML snippet: 模型表现 规则模型复盘 已复盘比赛 32 方向命中率 56.3 % 比分完全命中 3 平均总进球误差 1.5 32 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇳🇱 荷兰 90 / 🇸🇪 瑞典 83 防守 🇳🇱 荷兰 88 / 🇸🇪 瑞典 81 中场 🇳🇱 荷兰 89 / 🇸🇪 瑞典 82 状态 🇳🇱 荷兰 88 / 🇸🇪 瑞典 85 节奏 🇳🇱 荷兰 79 / 🇸🇪 瑞典 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇧🇷 巴西 96 🇲🇦 摩洛哥 96 🇺🇸 美国 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇺🇸 美国 92% 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇧🇷 巴西 81% 🇸🇪 瑞典 78% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 

## Deployment 2026-06-20T08:09:44.470Z

- Target: production
- Production URL: https://world-cup-match-intelligence-center.vercel.app
- Deployment URL: https://world-cup-match-intelligence-center-hw51rn7my.vercel.app
- Deployment ID: dpl_HmVdTrs92Haz23wSq5Ls11c1fTa9
- Inspect: https://vercel.com/jason-wang-s-projects1/world-cup-match-intelligence-center/HmVdTrs92Haz23wSq5Ls11c1fTa9
- Verification: passed
- Commands: npm run check:data, npm run lint, npm test, npm run build, npx vercel deploy --prod --yes
- Smoke checks:
  - /: HTTP 200, passed
  ...
  - /#group-standings: HTTP 200, passed
    - Production HTML snippet: 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。 
  - /#group-standings-consistency: HTTP 200, passed
    - Production HTML snippet: main: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::rnctm-1781942976273-63d27031cb99, x-matched-path=/, ok=true | main-random-query: status=200, cache-control=private, no-cache, no-store, max-age=0, must-revalidate, x-vercel-cache=MISS, x-vercel-id=hkg1::iad1::48qsj-1781942976827-aef6a44655e9, x-matched-path=/, ok=true | deployment-url-vercel-curl: status=200, cache-control=vercel curl, x-vercel-cache=vercel curl, x-vercel-id=vercel curl, x-matched-path=vercel curl, ok=true
  - /teams/mexico#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::hnbjg-1781942980944-2f7c55fea586 | A 组积分榜与出线形势 当前球队： 墨西哥 排名 球队 数据摘要 出线形势 1 墨西哥 · 当前球队 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 南非 · 2026-06-12 06/12 09:00 · 实际比分 墨西哥 2-0 南非 vs 韩国 · 2026-06-19 06/19 09:00 · 实际比分 墨西哥 1-0 韩国 剩余赛程 vs 捷克 · 2026-06-25 06/25 09:00 ，北京时间 · 未开始
  - /teams/canada#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::hnbjg-1781942981600-7b7540a7a381 | B 组积分榜与出线形势 当前球队： 加拿大 排名 球队 数据摘要 出线形势 1 加拿大 · 当前球队 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 已结束比赛 vs 波黑 · 2026-06-13 06/13 04:00 · 实际比分 加拿大 1-1 波黑 vs 卡塔尔 · 2026-06-19 06/19 10:00 · 实际比分 加拿大 6-0 卡塔尔 剩余赛程 vs 瑞士 · 2026-06-25 06/25 03:00 ，北京时间 · 未开始
  - /matches/match-008#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::hnbjg-1781942982021-deba7f822ddb | 捷克 vs 南非 北京时间 06/19 05:00 · Atlanta · Atlanta Stadium 实际比分 1-1 赛前预测 2-1 捷克 vs 南非 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 捷克 在模型中更占优势。当前主胜/平/客胜概率为 50% / 20.8% / 29.2%，预测比分 2 : 1。 捷克 胜 50 % 平局 20.8 % 南非 胜 29.2 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 16:05:20 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 04:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：捷克 1-1 南非 赛前预测：2-1；期望进球 1.5-0.6 A 组积分榜摘要 所属小组： A 组 本场赛果已计入 A 组积分榜。捷克获得 1 分，南非获得 1 分。 排名 球队 数据摘要 出线形势 1 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 1 - 1 赛前预测 2 - 1 胜平负方向 未命中 比分完全命中 未命中 净胜球偏差 1 总进球偏差 1 胜平负方向未命中，净胜球偏差 1，总进球偏差 1。 模型需要更重视临场伤停、红黄牌和比赛节
  - /matches/match-010#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::hnbjg-1781942982471-14254cc16703 | 加拿大 vs 卡塔尔 北京时间 06/19 10:00 · Vancouver · BC Place Vancouver 实际比分 6-0 赛前预测 2-1 加拿大 vs 卡塔尔 赛前智能分析 二级来源 · ESPN 2026 World Cup 赛程校验 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 加拿大 在模型中更占优势。当前主胜/平/客胜概率为 54.5% / 17.2% / 28.3%，预测比分 2 : 1。 加拿大 胜 54.5 % 平局 17.2 % 卡塔尔 胜 28.3 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/19 08:53:53 数据时间 来源抓取时间 2026/6/19 08:53:53 数据规范化时间 2026/6/20 16:05:20 赛果更新时间 2026/6/19 08:53:53 赛前预测快照 2026/6/19 09:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：加拿大 6-0 卡塔尔 赛前预测：2-1；期望进球 1.6-0.7 B 组积分榜摘要 所属小组： B 组 本场赛果已计入 B 组积分榜。加拿大获得 3 分，卡塔尔获得 0 分。 排名 球队 数据摘要 出线形势 1 加拿大 进球 7｜失球 1｜净胜球 +6｜积分 4 当前位于直接出线区，仍需后续比赛确认 2 瑞士 进球 5｜失球 2｜净胜球 +3｜积分 4 当前位于直接出线区，仍需后续比赛确认 3 波黑 进球 2｜失球 5｜净胜球 -3｜积分 1 当前处于第三名竞争区 4 卡塔尔 进球 1｜失球 7｜净胜球 -6｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 6 - 0 赛前预测 2 - 1 胜平负方向 命中 比分完全命中 未命中 净胜球偏差 5 总进球偏差 3 胜平负方向命中，净胜球偏差 5，总进球偏差 3。
  - /matches/match-029#standings-linkage: HTTP 200, passed
    - Production HTML snippet: x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::hnbjg-1781942982855-ffbebc2626f9 | 美国 vs Australia 北京时间 06/20 03:00 · Seattle · Seattle Stadium 实际比分 2-0 赛前预测 1-1 美国 vs Australia 赛前智能分析 官方来源 · FIFA World Cup 2026 官方赛程 根据 FIFA 官方赛程、FIFA 排名快照和本地规则模型整理，本场 美国 在模型中更占优势。当前主胜/平/客胜概率为 43.5% / 23.5% / 33%，预测比分 1 : 1。 美国 胜 43.5 % 平局 23.5 % Australia 胜 33 % 该预测为本地规则模型推断，不代表官方结论。 比赛状态 已结束 数据更新时间：2026/6/20 16:00:00 数据时间 来源抓取时间 2026/6/20 16:00:00 数据规范化时间 2026/6/20 16:05:20 赛果更新时间 2026/6/20 16:00:00 赛前预测快照 2026/6/20 02:59:00 状态按开赛时间加 2 小时的本地提示规则判断；预测快照与赛果更新时间相互独立。 比分信息 实际比分：美国 2-0 Australia 赛前预测：1-1；期望进球 1.3-1.4 D 组积分榜摘要 所属小组： D 组 本场赛果已计入 D 组积分榜。美国获得 3 分，Australia获得 0 分。 排名 球队 数据摘要 出线形势 1 美国 进球 6｜失球 1｜净胜球 +5｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 Australia 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 巴拉圭 进球 2｜失球 4｜净胜球 -2｜积分 3 当前处于第三名竞争区 4 Turkiye 进球 0｜失球 3｜净胜球 -3｜积分 0 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，非 FIFA 官方确认排名。 出线形势基于当前已录入赛果推断，仍需后续比赛确认。 赛后预测复盘 实际比分 2 - 0 赛前预测 1 - 1 胜平负方向 未命中 比分完全命中 未命中 净胜球偏差 2 总进球偏差 
  - /#ui-readability: HTTP 200, passed
    - Production HTML snippet: status=200 | cache-control=private, no-cache, no-store, max-age=0, must-revalidate | x-vercel-cache=MISS | x-vercel-id=hkg1::iad1::hnbjg-1781942983238-c5e5154ec31c | x-matched-path=/ | forbidden raw body=none | forbidden visible text=none | 小组积分榜与出线形势（本地规则推断） 基于当前已录入赛果和完整小组赛程计算，排序采用积分、净胜球、进球数等简化规则；第三名出线形势需结合其他小组结果，非 FIFA 官方确认排名。 A 组 · 4 / 6 场已结束 · 仍需后续比赛确认 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 排名 球队 数据摘要 出线形势 1 🇲🇽 墨西哥 进球 3｜失球 0｜净胜球 +3｜积分 6 当前位于直接出线区，仍需后续比赛确认 2 🇰🇷 韩国 进球 2｜失球 2｜净胜球 0｜积分 3 当前位于直接出线区，仍需后续比赛确认 3 🇨🇿 捷克 进球 2｜失球 3｜净胜球 -1｜积分 1 当前处于第三名竞争区 4 🇿🇦 南非 进球 1｜失球 3｜净胜球 -2｜积分 1 当前暂列小组第四，仍取决于剩余比赛 积分榜为本地简化规则，排序采用积分、净胜球、进球数和队名稳定排序，非 FIFA 官方确认排名。 第三名出线形势需结合其他小组结果；当前状态为基于已录入赛果的本地规则推断。 仍需后续比赛确认。  | 筛选比赛 按日期、小组、球队、状态和排序方式浏览。 全部日期 2026-06-12 2026-06-13 2026-06-14 2026-06-15 2026-06-16 2026-06-17 2026-06-18 2026-06-19 2026-06-20 2026-06-21 2026-06-22 2026-06-23 2026-06-24 2026-06-25 2026-06-26 2026-06-27 2026-06-28 全部小组 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 当前小组/收藏球队 🇲🇽 墨西哥 (MEX) 🇿🇦 南非 (RSA) 🇰🇷 韩国 (KOR) 🇨🇿 捷克 (CZE) 全部状态 进行中 进行中，比分待更新 已结束 未开始 赛果待更新 时间或数据异常 按开赛时间 按冷门风险 🇲🇽 墨西哥 MEX 🇿🇦 南非 RSA 🇰🇷 韩国 KOR 🇨🇿 捷克 CZE 显示当前小组/收藏球队；完整 48 队请用搜索定位。 完整小组赛数据 72 场小组赛数据 · 2026-06-12 至 2026-06-28 A 组 B 组 C 组 D 组 E 组 F 组 G 组 H 组 I 组 J 组 K 组 L 组 🇳🇱 荷兰 vs 🇸🇪 瑞典 2026-06-21 06/21 01:00 · 未开始 🇩🇪 德国 vs 🇨🇮 科特迪瓦 2026-06-21 06/21 04:00 · 未开始 🇪🇨 厄瓜多尔 vs 🇨🇼 库拉索 2026-06-21 06/21 08:0 | 模型表现 规则模型复盘 已复盘比赛 32 方向命中率 56.3 % 比分完全命中 3 平均总进球误差 1.5 32 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇳🇱 荷兰 90 / 🇸🇪 瑞典 83 防守 🇳🇱 荷兰 88 / 🇸🇪 瑞典 81 中场 🇳🇱 荷兰 89 / 🇸🇪 瑞典 82 状态 🇳🇱 荷兰 88 / 🇸🇪 瑞典 85 节奏 🇳🇱 荷兰 79 / 🇸🇪 瑞典 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇧🇷 巴西 96 🇲🇦 摩洛哥 96 🇺🇸 美国 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇺🇸 美国 92% 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇧🇷 巴西 81% 🇸🇪 瑞典 78% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 数据来源与更新时间 本地数据最近更新： 2026-06-20 16:05 ，北
  - /#chart-disclaimers: HTTP 200, passed
    - Production HTML snippet: 模型表现 规则模型复盘 已复盘比赛 32 方向命中率 56.3 % 比分完全命中 3 平均总进球误差 1.5 32 场复盘来自当前 72 场样本中已经录入实际比分且存在赛前预测快照的比赛；表现统计只覆盖当前 MVP 示例数据，不能代表完整世界杯模型效果。 全量样本热度排行（演示口径） 项目 / 数值 项目 数值 🏴 英格兰-🇭🇷 克罗地亚 96 🏴 英格兰-🇬🇭 加纳 96 🇵🇦 巴拿马-🏴 英格兰 96 🇦🇷 阿根廷-🇩🇿 阿尔及利亚 95 🇦🇷 阿根廷-🇦🇹 奥地利 95 🇯🇴 约旦-🇦🇷 阿根廷 95 全量 72 场样本的演示热度字段，用于界面排序和模型示例；不是官方数据、官方关注度，也不是全网实时舆情。 全量样本球队雷达图（演示模型） 项目 / 数值 项目 数值 进攻 🇳🇱 荷兰 90 / 🇸🇪 瑞典 83 防守 🇳🇱 荷兰 88 / 🇸🇪 瑞典 81 中场 🇳🇱 荷兰 89 / 🇸🇪 瑞典 82 状态 🇳🇱 荷兰 88 / 🇸🇪 瑞典 85 节奏 🇳🇱 荷兰 79 / 🇸🇪 瑞典 78 球队画像基于 FIFA 排名和 MVP 手动补充输入生成，属于本地演示模型口径；不是官方数据、官方能力评分或实时状态。 近期状态曲线 项目 / 数值 项目 数值 🇲🇽 墨西哥 96 🇧🇷 巴西 96 🇲🇦 摩洛哥 96 🇺🇸 美国 96 🇩🇪 德国 96 🇦🇷 阿根廷 96 🇸🇪 瑞典 95 🇫🇷 法国 95 状态指数是本地模型输入，不是官方指标。 小组出线概率（演示模型） 项目 / 数值 项目 数值 🇺🇸 美国 92% 🇨🇦 加拿大 87% 🇲🇽 墨西哥 86% 🇩🇪 德国 84% 🇧🇷 巴西 81% 🇸🇪 瑞典 78% 🇦🇷 阿根廷 76% 🇳🇴 挪威 75% 出线概率覆盖全量小组赛样本，为本地演示模型推断；不是官方数据、官方概率、博彩赔率或实时预测。 
